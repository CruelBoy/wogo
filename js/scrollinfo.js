var slideTxt={
	thisBox:$('.pbox'),//这里的样式名要与内容区保持一致
	btnLeft:$('a.left_btn'),
	btnRight:$('a.right_btn'),
	thisEle:$('.pbox ul'),
	init:function(){
		slideTxt.thisBox.width(slideTxt.thisEle.length*202);//这个宽度等于内容区的宽度，是内容移出去的宽度
		slideTxt.slideAuto();
	...
	slideLeft:function(){
		...
		slideTxt.thisBox.css('marginLeft',-202);//这个宽度等于内容区的宽度，是内容移出去的宽度
	...
	slideAuto:function(){
		slideTxt.intervalId=window.setInterval(slideTxt.slideRight,3000);//滚动间隔时间
		},
	slideStop:function(){
